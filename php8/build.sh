...
docker build ./php8.0-apache \
	-t touch4it/php8:php8.0.28-apache \
...
docker build ./php8.1-apache \
	-t touch4it/php8:php8.1.16-apache \
...
docker build ./php8.2-apache \
	-t touch4it/php8:php8.2.3-apache \
...
docker build ./php8.0-fpm-apache \
	-t touch4it/php8:php8.0.28-fpm-apache \
...
docker build ./php8.1-fpm-apache \
	-t touch4it/php8:php8.1.16-fpm-apache \
...
docker build ./php8.2-fpm-apache \
	-t touch4it/php8:php8.2.3-fpm-apache \
...
docker build ./php8.0-fpm-nginx \
	-t touch4it/php8:php8.0.28-fpm-nginx \
...
docker build ./php8.1-fpm-nginx \
	-t touch4it/php8:php8.1.16-fpm-nginx \
...
docker build ./php8.2-fpm-nginx \
	-t touch4it/php8:php8.2.3-fpm-nginx \
...
docker build ./php8.0-fpm-nginx-dev \
	-t touch4it/php8:php8.0.28-fpm-nginx-dev \
...
docker build ./php8.1-fpm-nginx-dev \
	-t touch4it/php8:php8.1.16-fpm-nginx-dev \
...
docker build ./php8.2-fpm-nginx-dev \
	-t touch4it/php8:php8.2.3-fpm-nginx-dev \
...
docker push touch4it/php8:php8.0.28-fpm-nginx
docker push touch4it/php8:php8.0-fpm-nginx

docker push touch4it/php8:php8.1.16-fpm-nginx
docker push touch4it/php8:php8.1-fpm-nginx

docker push touch4it/php8:php8.2.3-fpm-nginx
...
docker push touch4it/php8:php8.0.28-fpm-nginx-dev
docker push touch4it/php8:php8.0-fpm-nginx-dev

docker push touch4it/php8:php8.1.16-fpm-nginx-dev
docker push touch4it/php8:php8.1-fpm-nginx-dev

docker push touch4it/php8:php8.2.3-fpm-nginx-dev
