...
docker build ./php8.2-apache \
	-t touch4it/php8:php8.2.21-apache \
...
docker build ./php8.3-apache \
	-t touch4it/php8:php8.3.9-apache \
...
docker build ./php8.2-fpm-apache \
	-t touch4it/php8:php8.2.21-fpm-apache \
...
docker build ./php8.3-fpm-apache \
	-t touch4it/php8:php8.3.9-fpm-apache \
...
docker build ./php8.2-fpm-nginx \
	-t touch4it/php8:php8.2.21-fpm-nginx \
...
docker build ./php8.3-fpm-nginx \
	-t touch4it/php8:php8.3.9-fpm-nginx \
...
docker build ./php8.2-fpm-nginx-dev \
	-t touch4it/php8:php8.2.21-fpm-nginx-dev \
...
docker build ./php8.3-fpm-nginx-dev \
	-t touch4it/php8:php8.3.9-fpm-nginx-dev \
...
docker image push touch4it/php8:php8.2.21-apache
docker image push touch4it/php8:php8.2-apache

docker image push touch4it/php8:php8.3.9-apache
...
docker image push touch4it/php8:php8.2.21-fpm-apache
docker image push touch4it/php8:php8.2-fpm-apache

docker image push touch4it/php8:php8.3.9-fpm-apache
...
docker image push touch4it/php8:php8.2.21-fpm-nginx
docker image push touch4it/php8:php8.2-fpm-nginx

docker image push touch4it/php8:php8.3.9-fpm-nginx
...
docker image push touch4it/php8:php8.2.21-fpm-nginx-dev
docker image push touch4it/php8:php8.2-fpm-nginx-dev

docker image push touch4it/php8:php8.3.9-fpm-nginx-dev
