...
docker build ./php7.4-apache \
	...
	-t touch4it/docker-php7:php7.4.32-apache \
...
docker build ./php7.4-fpm-apache \
	...
	-t touch4it/docker-php7:php7.4.32-fpm-apache \
...
docker build ./php7.4-fpm-nginx \
	...
	-t touch4it/docker-php7:php7.4.32-fpm-nginx \
...
docker build ./php7.4-fpm-nginx-dev \
	...
	-t touch4it/docker-php7:php7.4.32-fpm-nginx-dev \
...
docker push touch4it/docker-php7:php7.4.32-fpm-nginx-dev
