...
docker build ./php7.2-fpm-nginx-drupal8.6 \
	...
	-t touch4it/drupal-php-fpm-nginx:8.6.7 \
...
docker build ./php7.2-fpm-nginx-drupal8.5 \
	...
	-t touch4it/drupal-php-fpm-nginx:8.5.10 \
...
docker build ./php7.3-fpm-nginx-drupal8.5-dev \
	-t touch4it/drupal-php-fpm-nginx:8.5-php7.3-dev \
	-f ./php7.3-fpm-nginx-drupal8.5-dev/Dockerfile
...
docker push touch4it/drupal-php-fpm-nginx:8.6.7
...
docker push touch4it/drupal-php-fpm-nginx:8.5.10
docker push touch4it/drupal-php-fpm-nginx:8.5
docker push touch4it/drupal-php-fpm-nginx:8.5-php7.2
docker push touch4it/drupal-php-fpm-nginx:8.5-php7.3
...
docker push touch4it/drupal-php-fpm-nginx:8.5-php7.3-dev
