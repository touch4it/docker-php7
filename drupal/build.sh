...
docker build ./php7.3-fpm-nginx-drupal8.8 \
	...
	-t touch4it/drupal-php-fpm-nginx:8.8.8 \
...
docker build ./php7.3-fpm-nginx-drupal8.9 \
	...
	-t touch4it/drupal-php-fpm-nginx:8.9.1 \
...
docker push touch4it/drupal-php-fpm-nginx:8.8.8
...
docker push touch4it/drupal-php-fpm-nginx:8.9.1
...
docker push touch4it/drupal-php-fpm-nginx:9.0.1
