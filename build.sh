...
docker build ./php7-apache \
	-t touch4it/docker-php7:php7-apache \
	-f ./php7-apache/Dockerfile

docker build ./php7.1-fpm-nginx \
...
docker push touch4it/docker-php7:php7-apache
